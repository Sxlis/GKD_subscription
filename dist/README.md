...
|淘宝|16|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>权限提示-通知权限<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限提示-悬浮窗权限<li>全屏广告-花呗推荐弹窗<li>局部广告-商品详情页直播悬浮窗<li>功能类-登录授权<li>全屏广告-支付后的推荐弹窗<li>局部广告-搜索页广告<li>功能类-消息清除未读|
